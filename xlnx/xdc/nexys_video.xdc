...
set_property -dict { PACKAGE_PIN AA19  IOSTANDARD LVCMOS33 } [get_ports { arty_a7_uart_tx }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=uart_rx_out
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { arty_a7_uart_rx }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in

set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS12 } [get_ports { arty_a7_sw_1 }]; #IO_L22N_T3_16 Sch=btnd
