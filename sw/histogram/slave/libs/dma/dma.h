...
// DMA CTRL/CFG/STATUS
#define dmaCTRL_CSR          (slaveDMA_0_BASE_ADDR)
...
#define dmaSTATUS            (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_STATUS_BYTE_OFFSET)
#define dmaERROR_ADDR        (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_ERROR_ADDR_BYTE_OFFSET)
#define dmaERROR_STAT        (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_ERROR_STATS_BYTE_OFFSET)

// DMA Descriptors
#define dmaDESC_0_SRC_ADDR   (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_SRC_ADDR_BYTE_OFFSET_0)
#define dmaDESC_0_DST_ADDR   (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_DST_ADDR_BYTE_OFFSET_0)
#define dmaDESC_0_NUM_BYTES  (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_NUM_BYTES_BYTE_OFFSET_0)
#define dmaDESC_0_DESC_CFG   (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_CFG_BYTE_OFFSET_0)

#define dmaDESC_1_SRC_ADDR   (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_SRC_ADDR_BYTE_OFFSET_1)
#define dmaDESC_1_DST_ADDR   (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_DST_ADDR_BYTE_OFFSET_1)
#define dmaDESC_1_NUM_BYTES  (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_NUM_BYTES_BYTE_OFFSET_1)
#define dmaDESC_1_DESC_CFG   (slaveDMA_0_BASE_ADDR+CSR_DMA_DMA_DESC_CFG_BYTE_OFFSET_1)
