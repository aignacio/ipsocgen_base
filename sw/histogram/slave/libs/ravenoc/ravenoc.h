...
#ifndef slaveRAVENOC_BASE_ADDR
  #define slaveRAVENOC_BASE_ADDR  0x00000000
#endif

#ifndef slaveNOC_SIZE_X
  #define slaveNOC_SIZE_X         1
  #define slaveNOC_SIZE_Y         2
  #define slaveNOC_TOTAL_TILES    2
#endif

#define ravenocWR_BUFFER           (slaveRAVENOC_BASE_ADDR + 0x1000)
#define ravenocRD_BUFFER           (slaveRAVENOC_BASE_ADDR + 0x2000)
#define ravenocCSR_BASE            (slaveRAVENOC_BASE_ADDR + 0x3000)
